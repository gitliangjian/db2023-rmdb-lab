...
selectItem:
    ...
    |   SUM '(' col ')' AS colName
    {
        $$ = std::make_shared<SelectItem>(AGG_FUNC_SUM, $3, false, $6);
    }
    |   MAX '(' col ')' AS colName
    {
        $$ = std::make_shared<SelectItem>(AGG_FUNC_MAX, $3, false, $6);
    }
    |   MIN '(' col ')' AS colName
    {
        $$ = std::make_shared<SelectItem>(AGG_FUNC_MIN, $3, false, $6);
    }
    |   COUNT '(' col ')' AS colName
    {
        $$ = std::make_shared<SelectItem>(AGG_FUNC_COUNT, $3, false, $6);
    }
    |   COUNT '(' '*' ')' AS colName
    {
        $$ = std::make_shared<SelectItem>(AGG_FUNC_COUNT, nullptr, true, $6);
    }
    ;
