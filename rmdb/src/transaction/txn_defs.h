...
class WriteRecord {
   public:
    ...
    inline std::vector<std::vector<char>> &GetOldIndexKeys() { return old_index_keys_; }
    inline std::vector<std::vector<char>> &GetNewIndexKeys() { return new_index_keys_; }
    inline void SetOldIndexKeys(std::vector<std::vector<char>> keys) { old_index_keys_ = std::move(keys); }
    inline void SetNewIndexKeys(std::vector<std::vector<char>> keys) { new_index_keys_ = std::move(keys); }
   ...
   private:
    ...
    Rid rid_;
    RmRecord record_;
    std::vector<std::vector<char>> old_index_keys_;
    std::vector<std::vector<char>> new_index_keys_;
};
